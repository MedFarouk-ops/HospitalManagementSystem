...
class AnalysteProfile extends StatefulWidget {
  const AnalysteProfile({Key? key}) : super(key: key);

  @override
  State<AnalysteProfile> createState() => _AnalysteProfileState();
}

class _AnalysteProfileState extends State<AnalysteProfile>
