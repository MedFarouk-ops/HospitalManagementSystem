...
class _PatientTodayReservationState extends State<PatientTodayReservation>
  ...
  void dispose() {
   ...
   List<Reservation> patientReservations = [];  
    ...
    _getReservationList() async {
      ...
      patientReservations = await PatientApiMethod().getPatientReservationList(user.id);
      setStateIfMounted(() {});
    }
